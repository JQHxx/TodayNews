 ...
 */
public class MvpEmptyViewProcessor implements IProcessor {
    @Override
    public void process(RoundEnvironment roundEnv, AnnotationProcessor mAbstractProcessor) {
        String CLASS_NAME = "MvpEmptyViewFactory";
        TypeSpec.Builder tb = TypeSpec.classBuilder(CLASS_NAME).addModifiers(PUBLIC, FINAL).addJavadoc("由APT自动生成的MVP空View");
        ...
        try {
            ...
            JavaFile javaFile = JavaFile.builder("com.todaynews.mvp", tb.build()).build();
